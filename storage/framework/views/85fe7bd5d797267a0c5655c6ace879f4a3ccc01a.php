...
<script type="text/javascript">
    $(document).ready(function () {
        $('#roodepoort').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('roodepoort'); ?>',
            columns: [
                {data: 'id', name: 'id', selectRow: true,},
                {data: 'name', name: 'name'},
                {data: 'email', name: 'email'},
