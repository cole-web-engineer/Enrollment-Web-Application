                    ...
                    <div class="card wizard-card" data-color="blue" id="wizard">
                        ...
                        <div class="container">
                            ...
                            <div class="row col-sm-8 col-sm-offset-2">
                                <p class="lead h3">
                                <a href="<?php echo e(url('https://www.taalct.co.za/make-payment/')); ?>" class="btn btn-primary btn-lg btn-outline-success"> <i class="fa fa-money 2x"></i>  Click To Pay Application Fee </a>
                            </p>
                            </div>
